...
export function getFriendList$Json(http: HttpClient, rootUrl: string, params?: GetFriendList$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<OtherUserViewModel>>> {
