...
export const SAVE_POST_NAVIGATION = 'save-post';
...
export const MOBILE_LANGUAGE_ID = 'mobile-language-id';
...
export const LEADERBOARD_NAVIGATION = 'leaderboard';
export const NOT_FOUND_NAVIGATION = 'not-found';
