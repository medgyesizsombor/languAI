...
{
    public static string ConnectionString { get; set; } = "Server=tcp:langu-ai-server.database.windows.net,1433;Initial Catalog=languai-db;Persist Security Info=False;User ID=langu-ai-admin;Password=RXd0SgnB!VAttHtcmCrAZ8N1KSvcFzcq;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
